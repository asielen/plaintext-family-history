...
Two **companions** live beside this suite, neither load-bearing: [`browser-companion/`](../browser-companion/) (web capture - vendored ready-to-load into every archive at `.fha/browser-companion/` by `fha install`/`update-tools`, since it has no build step; developed here) and [`obsidian-templater/`](../obsidian-templater/) (installed into a user's own Obsidian setup, never vendored) (optional Obsidian Templater templates for new person/source notes; see [docs/USING_WITH_OBSIDIAN.md](https://github.com/asielen/plaintext-family-history/blob/master/docs/USING_WITH_OBSIDIAN.md)).
