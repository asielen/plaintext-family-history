...
**Current: `spec v1.2` — milestones 1–5 complete, plus `fha packet` (milestone 6.1) and `fha places` (milestone 6.2).**
...
`fha report` session feed, `fha packet`, and `fha places`. See `BUILD.md` for the detailed
