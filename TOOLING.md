...
- **`fha views brackets`** → folder maintenance for the `people/` tree, covering four concerns in one pass (all previewed; `--fix` applies 1-3, `--fix-promote` applies 4):
