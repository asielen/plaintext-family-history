...
The deterministic write-backs for a person record's own frontmatter and prose. The group exists so that a field or a bounded prose edit every export decision or workbench button hangs on is a safe one-line command instead of a hand edit. Nine verbs ship: `set-living`, `set-profile-photo`, `new`, `relate`, `estimate`, `edit`, `note`, `edit-note`, `promote`.
